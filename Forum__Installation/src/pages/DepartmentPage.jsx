      ...
      {card && (
        <>
          ...
          >
            ...
            {/* Icon badge */}
            <div style={{ width: "56px", height: "56px", borderRadius: "16px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px" }}>
              {card.icon}
            </div>
            ...
            {/* Accent line */}
            <div style={{ width: "48px", height: "2px", background: "rgba(255,255,255,0.2)", borderRadius: "2px", marginBottom: "20px" }} />
            ...
            {/* Detail text */}
            <p style={{ color: "#CBD5E1", lineHeight: "1.85", fontSize: "1rem", fontWeight: 400 }}>
              {card.detail}
            </p>
          </motion.div>
        </>
      ...
      <section style={{ padding: "0 24px 100px", maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px" }}>
          {cards.map((card, i) => (
            ...
            >
              {/* Icon badge */}
              <div style={{ width: "52px", height: "52px", borderRadius: "14px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                {card.icon}
              </div>
              ...
              {/* Short desc */}
              <p style={{ color: "#94A3B8", fontSize: "0.95rem", lineHeight: "1.7", fontWeight: 400 }}>
                {card.shortDesc}
              </p>

              {/* View Details hint */}
              <div style={{ color: "#FFFFFF", fontSize: "0.85rem", fontWeight: 600, marginTop: "auto", display: "flex", alignItems: "center", gap: "4px" }}>
                View Details →
              </div>
            </motion.div>
          ))}
