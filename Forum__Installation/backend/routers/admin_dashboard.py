...
async def get_dashboard_stats(
    ...
    total_participants = approved * 2  # default team_size
    ...
    recent_regs = [
        {
            "id": r.TeamRegistration.id,
            "registration_id": r.TeamRegistration.registration_id,
        ...
        for r in recent_regs_result.all()
    ]
